...
# Run Time Density for Individual File Sizes
...
```{r individual_computation}
rmd <- sapply(
  unique(current$file_size),
  function(x) {
    knit_expand(file="individual_density.tmpl.rmd", file_size=x)
  }
)
rmd <- paste(rmd, collapse = "\n")
```  
```{r individual_output, results="asis"} 
