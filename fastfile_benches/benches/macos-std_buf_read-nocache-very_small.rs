use fastfile_benches::{
    benches::{cleanup, methods::std::buf_read::read, prepare, FILE_SIZES_VERY_SMALL as FILE_SIZES},
    benchmark::Benchmark,
};

#[allow(clippy::redundant_closure)] // this is for clippy and the read closure
fn main() {
    let benchmark_name = "Std: buf_read, NOT cached, very small [64 B - 128 KiB]";
