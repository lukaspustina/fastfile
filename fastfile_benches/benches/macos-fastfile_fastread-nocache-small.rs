use fastfile_benches::{
    benches::{cleanup, methods::fastfile::fastread::read, prepare, FILE_SIZES_SMALL as FILE_SIZES},
    benchmark::Benchmark,
};

fn main() {
    let benchmark_name = "FastFile: fastread, NOT cached, very small [1 KiB - 2 MiB]";
